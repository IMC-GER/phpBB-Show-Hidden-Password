...
if (document.getElementById('password')) {
	var imcgerPwStart = new imcgerPw(document.getElementById('password'));
}

if (document.getElementById('new_password')) {
	var imcgerPwNew = new imcgerPw(document.getElementById('new_password'));
}

if (document.getElementById('password_confirm')) {
	var imcgerPwConfirm = new imcgerPw(document.getElementById('password_confirm'));
}
